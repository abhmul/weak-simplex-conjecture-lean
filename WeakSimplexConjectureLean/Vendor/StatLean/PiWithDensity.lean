...
`StatLean/AsymptoticStatistics/ForMathlib/PiWithDensity.lean` (Apache-2.0).

Changes are limited to this attribution block and outer `WeakSimplex.Vendor.StatLean`
namespace isolation. The declaration bodies match the selected upstream source.
-/
