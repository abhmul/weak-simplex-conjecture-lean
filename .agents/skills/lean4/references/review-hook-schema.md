...
For CI automation, use `codex exec` with structured output. See [review.md](https://github.com/cameronfreer/lean4-skills/blob/main/plugins/lean4/commands/review.md#codex-integration) for details.
...
- [`/lean4:review`](https://github.com/cameronfreer/lean4-skills/blob/main/plugins/lean4/commands/review.md) - Review command documentation
