...
**See also:** [Repair Mode](https://github.com/cameronfreer/lean4-skills/blob/main/plugins/lean4/commands/prove.md#repair-mode) for escalation-only repair policy.
