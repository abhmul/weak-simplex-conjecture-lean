...
Upstream path: StatLean/AsymptoticStatistics/ForMathlib/PiWithDensity.lean
License: Apache-2.0; see StatLean/LICENSE.
Apart from this notice, the only local change is
`#print axioms MeasureTheory.pi_withDensity_prod`; all upstream source is otherwise byte-for-byte
unchanged.
-/
...
#print axioms MeasureTheory.pi_withDensity_prod
