...
Upstream path: StatLean/AsymptoticStatistics/ForMathlib/Contiguity.lean, lines 197-213
License: Apache-2.0; see StatLean/LICENSE.
Apart from this notice, local changes added two direct Mathlib imports, opened the ENNReal
notation scope, restored the enclosing namespace, and added the top-level axiom print. The
declaration body is unchanged.
-/
...
#print axioms AsymptoticStatistics.Measure.withDensity_map_eq_map_withDensity
